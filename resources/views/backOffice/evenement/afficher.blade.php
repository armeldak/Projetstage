...
@section('content')
            ...
            <div class="card card-box">
                <div class="card-head">
                    <header>Listes des evenement </header>
                    <div class="tools">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ $evenement->nom_ev }}</td>
                                        <td>{{ $evenement->description_ev}}</td>
                                        <td>{{ $evenement->date_ev}}</td>
                                        <td>{{ $evenement->duree_ev}}</td>

                                        <td> <a href="{{ route('editer-salle', $evenement->evenement_id) }}" ><button type="button" class="btn btn-outline-info" >Modifier</button></a>
